...
import 'create_company_account_screen.dart';
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.verified_user_outlined, size: 36, color: Colors.black87),
              ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: isButtonEnabled ? Colors.black : const Color(0xFFE0E0E0),
              ...
              Row(
                ...
                children: [
                  const Text("Student? ", style: TextStyle(fontSize: 14, color: Colors.grey)),
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context, 
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontSize: 11, color: Colors.grey.shade500, letterSpacing: 0.8, fontWeight: FontWeight.w600),
            ),
          ],
        ),
      ),
